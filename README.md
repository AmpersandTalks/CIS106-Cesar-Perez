...
In Session 14 files are introduced. Files are described as an object on a computer that stores data, information, settings, or commands used with a computer program. files can be opened, read, write/edit, and delete files. In this session, I also learned that text files consist of ASCII data which is a set of characters. the assignments require a text file to be present to reference back. The program must try to locate the file through the file path and file name. I have also learned about the file data type. This data type is support by most programming languages and the object of file data type can be used in reading and write the file.

## Final Project

Programming language is a language in which a computer interprets and executes. Programming language is also a way to communicate with a computer by making it easier for the computer to understand the set of instructions it should execute in a certain order. There are a variety of different languages such as C, C++, Java, Python, and so on. This semester has taught me many programming concepts such as variables, identifiers, operators, loops, error handling, functions, string operations, and read/write files. These concepts are very simple and easy by applying to different programming languages. We have learned to apply these concepts in our assignment programs and implement different logical solutions to solve errors that may occur. I chose Python for this course due to the fact that JavaScript was more on the difficult side to learn as opposed to Python. I want to pursue more knowledge in programming, as well as use these concepts as my foundation of programming to further develop my knowledge in Coding.
